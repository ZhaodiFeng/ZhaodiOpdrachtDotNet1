...
namespace MVC.Controllers
{
    public class ArtistsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,BirthDay,Bio")] Artist artist)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,BirthDay,Bio")] Artist artist)
        {
            if (ModelState.IsValid)
            {
        ...
        {
           artistRepository.DeletArtistById(id);
            return RedirectToAction("Index");
        }
